...
''';
  ...
  static TosReport pdfDemoReport() => const TosReport(
        summary: '총 4건의 위험 조항이 발견되었습니다. 개인정보 제3자 제공, 부가서비스 일방적 변경, '
            '외화계좌 정보 위임, 무승인 결제 환율 리스크를 확인하세요.',
        clauses: [
          RiskClause(
            level: RiskLevel.danger,
            title: '🔓 [개인정보 유출 위험] 제휴사·해외 가맹점에 결제정보 제3자 제공',
            clause: '카드이용약관 (개인정보의 제3자 제공 및 국외 처리위탁)',
            description: '카드 이용내역과 개인정보가 제휴사, 해외 카드사·가맹점 등 다수의 제3자에게 제공·위탁될 수 '
                '있다고만 안내되어, 실제로 어디까지 정보가 공유되는지 사용자가 파악하기 어렵고 유출 위험이 커집니다.',
          ),
          RiskClause(
            level: RiskLevel.danger,
